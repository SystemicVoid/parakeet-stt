...
from parakeet_stt_daemon.tail_trim import DEFAULT_MAX_TAIL_TRIM_SECS, DEFAULT_SILENCE_FLOOR_DB
...
# Mirror the Daemon Seal path tail-trim policy so `just eval stream` exercises it.
DEFAULT_STREAM_SILENCE_FLOOR_DB = DEFAULT_SILENCE_FLOOR_DB
DEFAULT_STREAM_MAX_TAIL_TRIM_SECS = DEFAULT_MAX_TAIL_TRIM_SECS
PROBE_STREAM_CHUNK_SECS = 1.6
PROBE_STREAM_RIGHT_CONTEXT_SECS = 2.4
PROBE_STREAM_LEFT_CONTEXT_SECS = 2.0
PROBE_STREAM_BATCH_SIZE = 4
